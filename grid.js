  ...
  for (var rowContent of gridContent) {
    ...
    if (typeof rowContent.texts !== 'undefined') {
      for (var text of rowContent.texts) {
        row$.append($('<div/>', { class: 'col-' + text.size + '-12 colHead', html: text.html }));
      }
    }
  }
}
...
function rowFromContent(rC) {
  return $('<div/>', { class: 'grid grid-pad ' + rC.gridClass, id: rC.id }).append(
...
function tileFromContent(tC) {
  ...
  return $('<div/>', { class: tC.class }).append(
    $('<div/>', {
      class: 'tileContent ' + tC.color + tC.hotword,
      id: tC.rowID + tC.name,
      tileRow: tC.rowID,
    })
      .append(
        $('<div/>', {
          class: 'tileImg',
          html: tC.img ? "<img src='images/" + tC.img + "_sm.png' />" : '',
        }),
      )
    ...
    $('<div/>', { class: dropdownClass }).append(
      $('<div/>', { class: 'descContent' })
        .append(
          $('<div/>', {
            class: 'descImg',
            html: tC.img ? "<img src='images/" + tC.img + ".png' />" : '',
          }),
        )
